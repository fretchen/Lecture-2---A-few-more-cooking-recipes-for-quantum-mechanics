In the \href{https://www.authorea.com/326007/wyOpqBcLPiiNhswBbwDHbA}{first lecture} we discussed briefly the basic principles like operators, state vectors and the Schrödinger equation. We will finish this discussion today and then introduce the most imp
