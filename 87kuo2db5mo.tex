...
\begin{align}
  ...
  &= \left(\alpha_\uparrow |\alpha_\uparrow|^2\ket{\uparrow}\bra{\uparrow}+\alpha_\downarrow\ket{\downarrow}\right)\left(\alpha_\uparrow\bra{\uparrow}+\alpha_\downarrow\bra{\downarrow}\right)
\end{align}
