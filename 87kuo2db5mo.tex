...
\begin{align}
  ...
  &= \left(\alpha_\uparrow\ket{\uparrow}\alpha_\uparrow\bra{\uparrow}+\alpha_\downarrow\ket{\downarrow}\right)\left(\alpha_\uparrow\bra{\uparrow}+\alpha_\downarrow\bra{\downarrow}\right)
\end{align}
