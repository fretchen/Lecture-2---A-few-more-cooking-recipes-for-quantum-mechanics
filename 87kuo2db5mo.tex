...
\begin{align}
  ...
  &= \left(|\alpha_\uparrow|^2\ket{\uparrow}\bra{\uparrow}+|\alpha_\downarrow|^2\ket{\uparrow}\bra{\uparrow}\left(\alpha_\uparrow\bra{\uparrow}+\alpha_\downarrow\bra{\downarrow}\right)
\end{align}
