...
We can now come back to measuring only parts of a system. Let us write the system as $S = S_A \otimes S_2$ comprised of two subsystems $S_1$, $S_2$, then the density operator $\hat{\rho}_i$ of  subsystem $i$ is
					%
					\begin{align}
