...
We can now come back to measuring only parts of a system and the photons sent to Alice and Bob. Let us write the system as $S = S_A \otimes S_B$ comprised of two subsystems $S_1$, $S_2$, then the density operator $\hat{\rho}_i$ of  subsystem $i$ is
					%
					\begin{align}
