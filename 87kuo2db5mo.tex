...
Let us write the system as $S = S_A \otimes S_B$.  If we are looking for thdcomprised of two subsystems $S_1$, $S_2$, then the density operator $\hat{\rho}_i$ of  subsystem $i$ is
					%
					\begin{align}
