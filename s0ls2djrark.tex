\section{Motion of a Point-Like Particle}
		\subsection{Wave Functions}
			...
			\begin{align}
				...
				&= \frac{1}{(2\pi\hbar)^{\frac{3}{2}}} \int \dif \vv{r} \exp\left({i \vv{p}\cdot\vv{r}}/{\hbar}\right)\ket{\vv{r}},
			\end{align}
			...
			\begin{align}
				...
				&=\frac{1}{(2\pi\hbar)^{\frac{3}{2}}} \int\dif\vv{r}\exp\left(-i\vv{p}\cdot\vv{r}/{\hbar}\right)\psi(\vv{r}) \label{eq:fourier}
			\end{align}
