...
We now  would like to understand than if we can disentangle the information about the different labels. NaWe can now now associate with Alice one set of outcomes ${}$ and with Bob another set:
\begin{align}
