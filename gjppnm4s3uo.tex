...
\begin{align}
	\ket{\psi_A}&= a_{\uparrow} \ket{\uparrow}+ a_{\downarrow} \ket{\downarrow}\\
	\ket{\psi_A}&= a_{\uparrow} \ket{\uparrow}+ a_{\downarrow} \ket{\downarrow}			\ket{\psi_B}&=\sum_n^N b_n \ket{\beta_n}.
\end{align}
