...
We now  would like to understand than if we can disentangle the information about the different labels. All other states are called \textit{entangled}. As for the shared coin, we
