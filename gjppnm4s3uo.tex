...
\begin{align}
\ket{\psi} &= \alpha_{\uparrow\uparrow}(\ket{\uparrow_A}\otimes\ket{\uparrow_B})+\alpha_{\uparrow\downarrow}\ket{\uparrow_A}\otimes\ket{\downarrow_B}+\alpha_{\downarrow\uparrow}\ket{\downarrow_A}\otimes\ket{\uparrow_B}+\alpha_{\downarrow\downarrow}\ket{\downarrow}\otimes\ket{\downarrow}\\
