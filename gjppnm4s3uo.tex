...
Another,  the simple example of two spins, each one having two possible states $\{\uparrow, \downarrow\}$. The full state will then be connected through a tensor product:
\begin{align}
