...
\begin{align}\label{Eq:Local}
	\ket{\psi_A}&= a_{\uparrow} \ket{\uparrow_A}+ a_{\downarrow_A} \ket{\downarrow_A}\\
	\ket{\psi_B}&= b_{\uparrow} \ket{\uparrow_B}+ b_{\downarrow_B} \ket{\downarrow_B}
\end{align}
...
&=a_{\uparrow} b_\uparrow \ket{\uparrow\uparrow}+ a_{\downarrow_A} \ket{\downarrow_A}\\
	\ket{\psi_B}&= b_{\uparrow} \ket{\uparrow_B}+ b_{\downarrow_B} \ket{\downarrow_B}
\end{align}
