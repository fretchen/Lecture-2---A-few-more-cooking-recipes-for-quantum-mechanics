...
The full state will then be described by the possible outcomes $\{\uparrow_A\uparrow_B,\downarrow_A\uparrow_B,\uparrow_A\downarrow_B, \uparrow_A\downarrow_B\}$through a tensor product:
\begin{align}
