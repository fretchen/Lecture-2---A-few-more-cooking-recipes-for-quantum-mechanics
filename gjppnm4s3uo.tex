...
\end{align}
So we will typically just plug the labels into a single ket, to avoid rewriting the tensor symbol each time. This is a standard problem in optical communication, where you send correlated photons with a certain polarization to different people. We will typically call the
